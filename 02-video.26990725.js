...
"[object Array]"!=r.call(e)?t.reject(TypeError("Not an array")):new t(function(n,r){if("function"!=typeof n||"function"!=typeof r)throw TypeError("Not a function");s(t,e,function(e,t){n(t)},r)}))}),h)}(),e.exports&&(e.exports=F[t]),n.exports),N=new WeakMap;/**
 ...
 * @return {void}
 */function L(e,t,n){var r=N.get(e.element)||{};t in r||(r[t]=[]),r[t].push(n),N.set(e.element,r)}/**
 * Get the callbacks for a player and event or method.
 *
 * @param {Player} player The player object.
 * @param {string} name The method or event name
 * @return {function[]}
 */function A(e,t){return(N.get(e.element)||{})[t]||[]}/**
 ...
 */function R(e,t,n){var r=N.get(e.element)||{};if(!r[t])return!0;// If no callback is passed, remove all callbacks for the event
if(!n)return r[t]=[],N.set(e.element,r),!0;var o=r[t].indexOf(n);return -1!==o&&r[t].splice(o,1),N.set(e.element,r),r[t]&&0===r[t].length}/**
...
r.element=i,r._originalElement=e,n=e,o=N.get(n),N.set(i,o),N.delete(n),H.set(r.element,r),t)}).catch(n)}});if(// Store a copy of this Player in the map
...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ef(t)||0,es(n)&&(s=!!n.leading,i=(f="maxWait"in n)?eu(ef(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(el())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const ed=new Q("vimeo-player");function eh(e){let t=e.seconds;!function(e,t){try{let n=JSON.stringify(t);localStorage.setItem(e,n)}catch(e){console.error(e)}}("videoplayer-current-time",t)}ed.ready().then(()=>{var e;let t=localStorage.getItem("videoplayer-current-time");t&&ed.setCurrentTime(parseFloat(t)),ed.on("timeupdate",((e=B)&&e.__esModule?e.default:e)(eh,1e3))});//# sourceMappingURL=02-video.26990725.js.map

//# sourceMappingURL=02-video.26990725.js.map
